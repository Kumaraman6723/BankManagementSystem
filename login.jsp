    ...
    <div class="login-container">
        <div class="wrapper">
            <div id="formContent">
                ...
                <h2 class="inactive underlineHover"><a href="signup.jsp">Sign Up</a> </h2><br>
                <h2>Login With Your SEVA BANK Account</h2>
                <!-- Icon -->
                ...
                <form class="login-form" action="Login" method="post">
                    <input type="text" id="accountNumber" class="fadeIn second" name="accountNumber"
